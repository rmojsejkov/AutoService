...
import { CustomButtonAdding, InputContainer, ServiceBlockItem } from '../../../components';
 ...
 * @constructor
 */
const AutoElectricianScreenView = () => {
  return (
      ...
      <FlatList
        ...
        renderItem={(itemData) => (
          <ServiceBlockItem
            ...
            onSelect={electricianSelectHandler.bind(this)}
          />
        )}
...
export const autoElectricianScreenOptions = (navData) => {
  return {
    ...
    headerLeft: () => <HeaderToggleButton navData={navData} />,
  };
};
/**
 * Стили экрана
